CREATE DATABASE  IF NOT EXISTS `faq` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `faq`;
...
CREATE TABLE `ev_tbl` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_company_q` (`question`(255))
...
-- Dump completed on 2025-09-24  9:49:39
