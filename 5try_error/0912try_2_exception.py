...
try: 
    ...
    print(f'오류발생 : {e}')   
    #하기와 같이 정확한 error 이름이 나오진 않음. Exception 이 상위 error class 라서. 
    #오류발생 : list index out of range  / 이걸로 실행할 때 print(f'결과는 = {calc_lists[choice]}')
    #오류발생 : invalid literal for int() with base 10: '백'
